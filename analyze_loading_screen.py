...
def analyze_loading_screen():
    ...
    rom_paths = ["tetris.gb", "tetris.gbc"]
    rom_path = None
    ...
    try:
            ...
            if screen is not None:
                ...
                if hasattr(screen, 'ndarray'):
                    try:
                        ...
                        img.save("loading_screen_analysis/initial_state.png")
                        print("Initial screenshot saved using screen.ndarray")
                ...
                if hasattr(screen, 'image'):
                    try:
                        ...
                        if callable(img_func):
                            ...
                            img = img_func
                        img.save("loading_screen_analysis/initial_state.png")
                        print("Initial screenshot saved using screen.image")
                    except Exception as e:
                        print(f"Error using image: {e}")
                else:
                    print("Could not find a method to get screen data")
            else:
                print("Failed to save initial screenshot - screen is None")
        except Exception as e:
        ...
        pyboy.screen_image().save("loading_screen_analysis/after_start_game.png")
        print("Screenshot after start_game saved")
        ...
        for i in range(120):
            ...
            if i % 30 == 0:
                ...
                pyboy.screen_image().save(f"loading_screen_analysis/frame_{i}.png")
        ...
        pyboy.screen_image().save("loading_screen_analysis/after_start_button.png")
        print("Screenshot after START button saved")
        ...
        for i in range(60):
            ...
            if i % 20 == 0:
                ...
                pyboy.screen_image().save(f"loading_screen_analysis/after_start_{i}.png")
        ...
        pyboy.screen_image().save("loading_screen_analysis/after_second_start.png")
        print("Screenshot after second START button saved")
        ...
        pyboy.screen_image().save("loading_screen_analysis/after_a_button.png")
        print("Screenshot after A button saved")
        ...
        pyboy.screen_image().save("loading_screen_analysis/final_state.png")
